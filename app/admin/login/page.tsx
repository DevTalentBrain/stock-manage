  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col justify-center items-center p-6 text-white font-sans antialiased">
      <div className="max-w-[400px] w-full bg-[#1c1c1e] p-10 rounded-[2.5rem] shadow-2xl border border-white/5">
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-2xl animate-in fade-in slide-in-from-top-2 duration-300">
        ...
        <form onSubmit={handleAdminLogin} className="space-y-4">
          <div className="bg-[#2c2c2e] rounded-2xl overflow-hidden border border-white/5 focus-within:ring-2 focus-within:ring-blue-500/50 transition-all">
            <input
              type="text"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 text-white py-4 rounded-full font-black uppercase text-[11px] tracking-widest hover:bg-blue-500 transition-all active:scale-95 shadow-lg shadow-blue-600/20 disabled:opacity-50 disabled:cursor-not-allowed"
          >
      ...
      <p className="mt-8 text-[9px] text-gray-700 uppercase font-bold tracking-[0.2em]">
